    ...
    if (isData != null) {
      ...
      if (this.sortBy == 'Name') {
        const filteredData = localData.filter((m: EmployeeObj) =>
          m.Name.toLocaleLowerCase().startsWith(
      ...
      if (this.sortBy == 'Technology') {
        const filteredData = localData.filter((m: EmployeeObj) =>
          m.Technology.toLocaleLowerCase().startsWith(
            this.searchText.toLocaleLowerCase()
          )
        );
        this.employeeArr = filteredData;
      ...
      if (this.sortBy == 'Designation') {
        const filteredData = localData.filter((m: EmployeeObj) =>
          m.Designation.toLocaleLowerCase().startsWith(
            this.searchText.toLocaleLowerCase()
          )
        );
        this.employeeArr = filteredData;
      ...
      if (this.sortBy == 'Skill') {
        const filteredData = localData.filter((m: EmployeeObj) =>
          m.Skill.toLocaleLowerCase().startsWith(
            this.searchText.toLocaleLowerCase()
          )
        );
        this.employeeArr = filteredData;
      ...
      if (this.sortBy == 'Core Expertise') {
        const filteredData = localData.filter((m: EmployeeObj) =>
          m.Core.toLocaleLowerCase().startsWith(
            this.searchText.toLocaleLowerCase()
          )
        );
        this.employeeArr = filteredData;
